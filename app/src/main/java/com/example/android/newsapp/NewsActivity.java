...
public class NewsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Article>> {
    ...
    private static final String API_TEST_KEY = "6fa6f15e-458d-4f0b-9c19-2701445a7c0e";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emptyTextView = (TextView) findViewById(R.id.empty_view_text);
        ...
        articleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (websiteIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    Log.i(LOG_TAG, "Unable to open the App as there is no browser installed in device!");
                }
            }
        });
